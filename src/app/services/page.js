...
export default function Services() {
  ...
  return (
    <main className="pt-16 min-h-screen">
      ...
      <section className="bg-gray-100 dark:bg-black text-black dark:text-white mx-auto p-8">
        <div className="container mx-auto flex flex-col lg:flex-row justify-end">
          {/* Left Section - Sticky Title */}
          <div className="w-full lg:w-1/2 lg:sticky top-20 self-start text-right">
