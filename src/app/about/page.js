    ...
    <main className="pt-16 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="max-w-3xl space-y-6 text-gray-700 dark:text-gray-300">
          <p>
            Welcome to <span className="font-semibold text-gray-900 dark:text-white">TechTrio Automation</span>,
            where we blend innovation with technology to create smart solutions for businesses. 
            Our expertise in **website development, software solutions, mobile applications, 
            and automation technologies** allows us to cater to a wide range of industries.
          </p>
          ...
          <p>
            Our mission is to **simplify and automate** everyday operations for businesses 
            by delivering **cost-effective, scalable, and high-performance** technology solutions.
          </p>
          ...
          <p>
            We aim to be a **leading technology solutions provider** by integrating AI, IoT, 
