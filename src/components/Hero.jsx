  ...
  return (
    <>
      ...
      <div className="marqueecontainer w-full h-screen relative overflow-hidden mt-10">
        <div className="heading absolute top-[7%] left-1/2 -translate-x-1/2 w-full px-4 md:w-60 text-center">
          <h1 className="text-base md:text-xl font-regular text-gray-900 dark:text-white">Crafting a new paradigm of parking, one that is</h1>
        </div>
        <div className="slidesm absolute scale-[0.8] md:scale-[1] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full md:w-[80%] space-y-6 md:space-y-8">
          {/* First Row */}
            ...
            <div className="flex whitespace-nowrap animate-[marquee_25s_linear_infinite] px-2 md:px-0">
              <div className="row lft w-full flex items-center justify-evenly gap-1 md:gap-6 min-w-full">
                <div className="elem flex items-center gap-1 md:gap-6">
                  ...
                  <div className="imgdiv w-[2rem] h-[2rem] md:w-[3.5rem] md:h-[3.5rem] rounded-full overflow-hidden bg-yellow-500">
                    <Image width={100} height={100} className="w-full h-full object-cover" src="/assets/images/sharmaji.jpg" alt="" />
                  </div>
                </div>
                <div className="elem flex items-center gap-1 md:gap-6">
                  <h1 className="font-semibold font-['Pp_Neue_Machina_Inktrap'] text-2xl md:text-6xl text-gray-900 dark:text-white">useful</h1>
                  <div className="imgdiv w-[2rem] h-[2rem] md:w-[3.5rem] md:h-[3.5rem] rounded-full overflow-hidden bg-yellow-500">
                    <Image width={100} height={100} className="w-full h-full object-cover" src="/assets/images/Nirbhay.jpg" alt="" />
                  </div>
                </div>
                <div className="elem flex items-center gap-1 md:gap-6">
                  <h1 className="font-semibold font-['Pp_Neue_Machina_Inktrap'] text-2xl md:text-6xl text-gray-900 dark:text-white">quick</h1>
                  <div className="imgdiv w-[2rem] h-[2rem] md:w-[3.5rem] md:h-[3.5rem] rounded-full overflow-hidden bg-yellow-500">
                    <Image width={100} height={100} className="w-full h-full object-cover" src="/assets/images/about-me.jpg" alt="" />
                  </div>
                </div>
              </div>
              <div className="row lft w-full flex items-center justify-evenly gap-1 md:gap-6 min-w-full">
            ...
            <div className="flex whitespace-nowrap animate-[marquee-reverse_20s_linear_infinite] px-2 md:px-0">
              <div className="row rgt w-full flex items-center justify-evenly gap-1 md:gap-6 min-w-full">
                <div className="elem flex items-center gap-1 md:gap-6">
                  ...
                  <div className="imgdiv w-[2rem] h-[2rem] md:w-[3.5rem] md:h-[3.5rem] rounded-full overflow-hidden bg-yellow-500">
                    <Image width={100} height={100} className="w-full h-full object-cover" src="/assets/images/aditi.jpg" alt="" />
                  </div>
                </div>
                <div className="elem flex items-center gap-1 md:gap-6">
          ...
          {/* Third Row */}
          <div className="overflow-hidden relative">
            <div className="flex whitespace-nowrap animate-[marquee_20s_linear_infinite] px-2 md:px-0">
              <div className="row lft w-full flex items-center justify-evenly gap-1 md:gap-6 min-w-full">
                <div className="elem flex items-center gap-1 md:gap-6">
                  <h1 className="font-semibold font-['Pp_Neue_Machina_Inktrap'] text-2xl md:text-6xl text-gray-900 dark:text-white">flexible</h1>
                  <div className="imgdiv w-[2rem] h-[2rem] md:w-[3.5rem] md:h-[3.5rem] rounded-full overflow-hidden bg-yellow-500">
